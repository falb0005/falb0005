...
/*******************************************************************
*	Function int asteroid_init(struct particle *p);
********************************************************************/
...
/*******************************************************************
*	Function int asteroid_add(struct particle **head);
********************************************************************/
...
/********************************************************************
*	Function int asteroid remove(struct particle *p);
*********************************************************************/
...
/*********************************************************************
*	Function int asteroid_destroy(struct particle **head);
**********************************************************************/
